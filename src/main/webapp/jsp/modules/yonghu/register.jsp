...
<style>
	...
	body {
				background-image: url(http://codegen.caihongy.cn/20210226/18ff2182da0148f487adbdbb691144eb.jpg) !important;
	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="yonghuxingming" placeholder="用户姓名" class="form-control-i">
							</div>
																																														<div class="form-group">
							<label class="label">手机号码</label> 
							<input type="text" name="shoujihaoma" placeholder="手机号码" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">医院名称</label> 
							<input type="text" name="yiyuanmingcheng" placeholder="医院名称" class="form-control-i">
							</div>
