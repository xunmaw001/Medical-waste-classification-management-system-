		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑医院垃圾信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>医院垃圾信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑医院垃圾信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">医院垃圾信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>垃圾名称</label>
										<input id="lajimingcheng" name="lajimingcheng" class="form-control" placeholder="垃圾名称">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>详细介绍</label>
										<textarea name="xiangxijieshao" class="form-control" id="xiangxijieshao" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>详情</label>
										<div>
										<div class="upload">选择文件<input name="file" type="file" class="form-control-file" id="xiangqingupload"></div>
										<label id="xiangqingFileName"></label>
										<input name="xiangqing" id="xiangqing-input" type="hidden">
										</div>
									</div>
	...
	<script>
		...
		var fenleiOptions = [];
				...
				function fenleiSelect(){
					http("option/yiyuanlajifenlei/fenlei","GET",{},(res)=>{
						if(res.code == 0){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yiyuanlajixinxi/info/" + id,
		...
		function upload(){
			...
			$('#xiangqingupload').fileupload({
				...
				dataType: 'json',
					...
					document.getElementById('xiangqing-input').setAttribute('value',baseUrl+'file/download?fileName='+data.result.file);
					if(document.getElementById('xiangqingFileName') != null){
						document.getElementById('xiangqingFileName').innerHTML = "上传成功!";
					}		
					$("#xiangqingImg").attr("src",data.result.file);												
				}
			});
		}  
		//取消 
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yiyuanlajixinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yiyuanlajixinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("yiyuanlajixinxi"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#lajimingcheng").val(ruleForm.lajimingcheng);	
			...
			$("#xiangxijieshao").val(ruleForm.xiangxijieshao);
			$("#xiangqing-input").val(ruleForm.xiangqing);
			$("#xiangqingFileName").html(ruleForm.xiangqing);
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.lajimingcheng != null && res.data.lajimingcheng != ''){

					$("#lajimingcheng").val(res.data.lajimingcheng);
					}
					...
					if(res.data != null && res.data != '' && res.data.xiangxijieshao != null && res.data.xiangxijieshao != ''){

					$("#xiangxijieshao").val(res.data.xiangxijieshao);
					}
					if(res.data != null && res.data != '' && res.data.xiangqing != null && res.data.xiangqing != ''){

					$("#xiangqing-input").val(res.data.xiangqing);
					$('#xiangqingFileName').val(res.data.xiangqing)
					}
				}
			});  
            }
